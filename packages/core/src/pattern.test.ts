...
// Real rudiments as the specimens for the hard cases below: the point is that
// the model holds up against the actual repertoire, not against a fixture.
...
import { equals, sum } from './fraction'
